...
public enum DtoInCreateEmployeesJobIdEnum {
	...
	@JsonProperty("PUBLIC_RELATIONS_REPRESENTATIVE")PUBLIC_RELATIONS_REPRESENTATIVE("PUBLIC_RELATIONS_REPRESENTATIVE");
	  ...
	  private DtoInCreateEmployeesJobIdEnum(final String code) {
	    this.code = code;
	  }

	  public static DtoInCreateEmployeesJobIdEnum getDtoInCreateEmployeesJobIdEnum(final String code) {
	    for(DtoInCreateEmployeesJobIdEnum item : DtoInCreateEmployeesJobIdEnum.values()) {
