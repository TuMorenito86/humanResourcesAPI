...
public enum DtoOutListEmployeesJobIdEnum {
	...
	@JsonProperty("PUBLIC_RELATIONS_REPRESENTATIVE")PUBLIC_RELATIONS_REPRESENTATIVE("PUBLIC_RELATIONS_REPRESENTATIVE");
	  ...
	  private DtoOutListEmployeesJobIdEnum(final String code) {
	    this.code = code;
	  }

	  public static DtoOutListEmployeesJobIdEnum getDtoInCreateEmployeesJobIdEnum(final String code) {
	    for(DtoOutListEmployeesJobIdEnum item : DtoOutListEmployeesJobIdEnum.values()) {
