...
public class DtoOutListEmployeesGet implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2227060340323181284L;
	@JsonProperty("id")
	private Long id;
	@JsonProperty("nombre")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DtoOutListEmployeesGet other = (DtoOutListEmployeesGet) obj;
