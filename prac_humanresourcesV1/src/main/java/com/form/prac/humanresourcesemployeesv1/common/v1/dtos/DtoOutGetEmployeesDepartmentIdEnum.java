...
public enum DtoOutGetEmployeesDepartmentIdEnum {
	...
	@JsonProperty("PAYROLL")PAYROLL("PAYROLL");
	  ...
	  private DtoOutGetEmployeesDepartmentIdEnum(final String code) {
	    this.code = code;
	  }

	  public static DtoOutGetEmployeesDepartmentIdEnum getDtoInCreateEmployeesJobIdEnum(final String code) {
	    for(DtoOutGetEmployeesDepartmentIdEnum item : DtoOutGetEmployeesDepartmentIdEnum.values()) {
