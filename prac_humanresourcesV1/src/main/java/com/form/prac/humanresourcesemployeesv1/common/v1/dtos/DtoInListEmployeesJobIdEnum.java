...
public enum DtoInListEmployeesJobIdEnum {
	...
	@JsonProperty("PUBLIC_RELATIONS_REPRESENTATIVE")PUBLIC_RELATIONS_REPRESENTATIVE("PUBLIC_RELATIONS_REPRESENTATIVE");
	  ...
	  private DtoInListEmployeesJobIdEnum(final String code) {
	    this.code = code;
	  }

	  public static DtoInListEmployeesJobIdEnum getDtoInCreateEmployeesJobIdEnum(final String code) {
	    for(DtoInListEmployeesJobIdEnum item : DtoInListEmployeesJobIdEnum.values()) {
