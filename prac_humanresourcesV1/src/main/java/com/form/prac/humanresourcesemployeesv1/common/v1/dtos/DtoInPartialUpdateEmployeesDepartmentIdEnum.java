...
public enum DtoInPartialUpdateEmployeesDepartmentIdEnum {
	...
	@JsonProperty("PAYROLL")PAYROLL("PAYROLL");
	  ...
	  private DtoInPartialUpdateEmployeesDepartmentIdEnum(final String code) {
	    this.code = code;
	  }

	  public static DtoInPartialUpdateEmployeesDepartmentIdEnum getDtoInCreateEmployeesJobIdEnum(final String code) {
	    for(DtoInPartialUpdateEmployeesDepartmentIdEnum item : DtoInPartialUpdateEmployeesDepartmentIdEnum.values()) {
