...
public enum DtoOutListEmployeesDepartmentIdEnum {
	...
	@JsonProperty("PAYROLL")PAYROLL("PAYROLL");
	  ...
	  private DtoOutListEmployeesDepartmentIdEnum(final String code) {
	    this.code = code;
	  }

	  public static DtoOutListEmployeesDepartmentIdEnum getDtoInCreateEmployeesJobIdEnum(final String code) {
	    for(DtoOutListEmployeesDepartmentIdEnum item : DtoOutListEmployeesDepartmentIdEnum.values()) {
